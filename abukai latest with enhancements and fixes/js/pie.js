...
function plotss(text, svgg) {
    ...
    d3.text(text, function(text) {
        ...
        //if(pies.style.minHeight=="100px")
        {
            ...
            var color = d3.scale.ordinal().range(["rgb(189, 201, 192)","rgb(250, 138, 10)","rgb(223, 232, 225)","rgb(255, 186, 59)","rgb(232, 229, 223)","rgb(255, 198, 92)","rgb(247, 243, 235)","rgb(250, 204, 117)"]);
            var colorarray=["rgb(189, 201, 192)","rgb(250, 138, 10)","rgb(223, 232, 225)","rgb(255, 186, 59)","rgb(232, 229, 223)","rgb(255, 198, 92)","rgb(247, 243, 235)","rgb(250, 204, 117)"];
  ...
  .data(pie(dataset))
  .enter()
  .append('text').attr('class',function(d){return d.count}).attr('class','textn')
  ...
  var datasets= JSON.parse(JSON.stringify(obj));
            ...
            var legend = svg.selectAll('.legend') // selecting elements with class 'legend'
                ...
                .style('opacity',0.3);// each stroke is passed a color
            ...
            legend.append('rect') // append rectangle squares to legend                                   
                ...
                .on('click', function(label) {
                    ...
                    if (rect.attr('class') === 'disabled') { // if class is disabled
                        ...
                        let rem=1;
                        for(let it=0; it<colorarray.length; it++)
                        {
                            console.log("rect fill is"+rect.style('fill'));
                             if(rect.style('fill')==colorarray[it])
                             {
                                 console.log("yes ut true");
                                  rem=it;
                             }
                        }
 
                        obj[rem].count=datasets[rem].count;
                        
                        rect.attr('class', ''); // remove class disabled
                        //obj[1].count=datasets[1].count;
